...
\NewPart{Summary}{I'm +3 years expriance Software Engineer, i start coding when i was 13, programming is more than a job for me it is a hoppy. i'm a self-motivated ,creative ,problem solver and determined Engineer. my objective is to contribute more to the open source community. }
...
\ProjectEntry{\href{https://github.com/peter44322/JoQueryGenerator}{JoQueryGenerator}}{An open source laravel package to help obtomizing datatables query. with the help of the colvis addon it joins table conditionaly.}
